...
const DataBank = {
  ...
  // ==========================================================
  // PRUEBA PROFESIONAL: PROTECCIÓN DE VÍCTIMAS Y TESTIGOS
  // ==========================================================
  ...
  profesional: {
    ...
    tiempo: 15 * 60,
    totalPreguntas: 15,
    instrucciones: '<p><strong>Prueba de Conocimientos Profesional</strong> sobre <strong>Protección de Víctimas y Testigos</strong>.</p><p><strong>Duración:</strong> 15 minutos | <strong>Preguntas:</strong> 15</p><p>Formato mixto: <strong>V/F/D</strong> y <strong>Selección Múltiple</strong>.</p><p>Áreas evaluadas:</p><ul><li>Conocimientos Generales Psicosociales (Victimología, Trauma y Duelo, Fenomenología)</li><li>Conocimientos Generales Jurídicos (Sistema de Justicia, Crimen Organizado, Protección)</li><li>Medidas de Protección</li></ul>',
    banco: [
      { tipo:'VFD', nivel:'facil', area:'Victimología', enunciado:'La victimización es el proceso por el cual una persona se convierte en víctima de un delito.', respuesta:'V', explicacion:'Correcto. La victimización es el proceso de convertirse en víctima.' },
      { tipo:'VFD', nivel:'facil', area:'Victimología', enunciado:'La revictimización ocurre cuando una persona es víctima de múltiples delitos simultáneamente.', respuesta:'F', explicacion:'La revictimización se refiere al daño adicional causado por el sistema judicial, no a múltiples delitos simultáneos.' },
      { tipo:'MC', nivel:'facil', area:'Victimología', enunciado:'¿Qué concepto describe la exposición repetida de una víctima al sistema de justicia generando nuevo daño?', opciones:['Victimización primaria','Revictimización','Polivictimización','Victimización secundaria'], respuesta:1, explicacion:'La revictimización es el daño adicional causado por la interacción con el sistema de justicia.' },
      { tipo:'MC', nivel:'intermedio', area:'Victimología', enunciado:'¿Cómo se denomina la victimización causada por las instituciones del sistema de justicia?', opciones:['Victimización primaria','Victimización directa','Victimización secundaria','Polivictimización'], respuesta:2, explicacion:'La victimización secundaria es producida por la interacción con las instituciones del sistema.' },
      { tipo:'VFD', nivel:'intermedio', area:'Victimología', enunciado:'La polivictimización se refiere a la exposición a múltiples tipos de victimización a lo largo de la vida.', respuesta:'V', explicacion:'Correcto. La polivictimización implica haber experimentado diferentes tipos de victimización.' },
      { tipo:'VFD', nivel:'dificil', area:'Victimología', enunciado:'La victimización secundaria es siempre provocada por el propio delincuente.', respuesta:'F', explicacion:'La victimización secundaria es causada por el sistema institucional, no por el delincuente.' },
      { tipo:'MC', nivel:'facil', area:'Trauma y Duelo', enunciado:'Según el DSM-5, ¿cuál es la característica esencial del TEPT?', opciones:['Exposición a un evento traumático','Cambios en el apetito','Problemas de sueño sin causa','Fobia social'], respuesta:0, explicacion:'El TEPT requiere exposición a un evento traumático como criterio esencial.' },
      { tipo:'VFD', nivel:'facil', area:'Trauma y Duelo', enunciado:'El duelo es exclusivamente una reacción emocional ante la muerte de un ser querido.', respuesta:'F', explicacion:'El duelo puede manifestarse ante diversas pérdidas significativas, no solo ante la muerte.' },
      { tipo:'VFD', nivel:'intermedio', area:'Trauma y Duelo', enunciado:'Los síntomas de TEPT incluyen reviviscencia, evitación y alteraciones negativas en cognición.', respuesta:'V', explicacion:'El DSM-5 describe cuatro grupos de síntomas característicos del TEPT.' },
      { tipo:'MC', nivel:'intermedio', area:'Trauma y Duelo', enunciado:'¿Cuál NO es un síntoma del TEPT según el DSM-5?', opciones:['Recuerdos intrusivos','Evitación de estímulos','Alucinaciones visuales','Alteraciones del estado de ánimo'], respuesta:2, explicacion:'Las alucinaciones visuales no son síntoma característico del TEPT.' },
      { tipo:'VFD', nivel:'dificil', area:'Trauma y Duelo', enunciado:'El duelo complicado se caracteriza por persistencia de síntomas más allá de los 12 meses.', respuesta:'V', explicacion:'El DSM-5 describe duelo complicado cuando los síntomas persisten más de 12 meses.' },
      { tipo:'MC', nivel:'facil', area:'Fenomenología', enunciado:'¿Qué caracteriza al crimen organizado según la Política Nacional?', opciones:['Actuación individual','Estructura jerarquizada y permanente','Delitos impulsivos','Ausencia de planificación'], respuesta:1, explicacion:'La estructura jerarquizada y permanente caracteriza al crimen organizado.' },
      { tipo:'VFD', nivel:'intermedio', area:'Fenomenología', enunciado:'La trata de personas y el tráfico ilícito de migrantes son delitos cometidos por organizaciones criminales.', respuesta:'V', explicacion:'Ambos delitos son frecuentemente ejecutados por organizaciones criminales transnacionales.' },
      { tipo:'MC', nivel:'facil', area:'Sistema de Justicia', enunciado:'¿Qué ley establece la Ley Orgánica Constitucional del Ministerio Público?', opciones:['Ley 19.640','Ley 20.000','Ley 21.057','Ley 19.733'], respuesta:0, explicacion:'La Ley 19.640 establece la LOC del Ministerio Público.' },
      { tipo:'VFD', nivel:'facil', area:'Sistema de Justicia', enunciado:'El Código Procesal Penal regula el procedimiento penal en Chile.', respuesta:'V', explicacion:'El CPP es el cuerpo legal que regula el procedimiento penal chileno.' },
      { tipo:'MC', nivel:'intermedio', area:'Delitos de Crimen Organizado', enunciado:'La Ley 20.000 sanciona el tráfico ilícito de:', opciones:['Armas','Estupefacientes y sustancias sicotrópicas','Migrantes','Especies protegidas'], respuesta:1, explicacion:'La Ley 20.000 sanciona el tráfico de estupefacientes y sustancias sicotrópicas.' },
      { tipo:'VFD', nivel:'intermedio', area:'Protección Especializada', enunciado:'La Ley 21.057 regula entrevistas grabadas en video para NNA víctimas de delitos sexuales.', respuesta:'V', explicacion:'La Ley 21.057 establece el sistema de entrevistas grabadas en video para NNA.' },
      { tipo:'MC', nivel:'dificil', area:'Protección Especializada', enunciado:'La Ley 21.675 estatuye medidas para prevenir, sancionar y erradicar:', opciones:['La trata de personas','La violencia contra las mujeres en razón de género','El crimen organizado','El tráfico de armas'], respuesta:1, explicacion:'La Ley 21.675 se enfoca en violencia contra las mujeres en razón de género.' },
      { tipo:'VFD', nivel:'facil', area:'Medidas de Protección', enunciado:'Las medidas de protección a víctimas y testigos buscan evitar su revictimización.', respuesta:'V', explicacion:'Prevenir la revictimización es un objetivo central de las medidas de protección.' },
      { tipo:'MC', nivel:'intermedio', area:'Medidas de Protección', enunciado:'¿Cuál de las siguientes es una medida de protección para víctimas y testigos?', opciones:['Reserva de identidad','Atención psicológica gratuita','Asignación de vivienda','Todas las anteriores'], respuesta:3, explicacion:'Todas son medidas de protección disponibles.' },
      { tipo:'VFD', nivel:'dificil', area:'Medidas de Protección', enunciado:'Las medidas de protección solo pueden aplicarse durante el juicio oral.', respuesta:'F', explicacion:'Pueden aplicarse en diversas etapas del proceso, no solo en juicio oral.' }
  },
